...
function Profile() {
  ...
  function handleSelect2(e) {
    ...
    render.onload = () => {
      setPreviewResume(render.result)
    ...
    <div className='w-full  flex justify-center md:h-[100vh]  '>
      <div className='w-[98%] md:w-[95%]  bg-[#0b0c1f] mt-24 md:flex md:justify-between '>
        ...
        <div className=' md:overflow-y-scroll  md:w-[55%] md:bg-[white] bg-[#0b0c1f]  '>
          <form action=" " onSubmit={handleSubmit} className=' flex flex-col items-center w-full gap-4 font-semibold'>
            <div className='my-2 '>
            ...
            <div className=' w-full md:w-full lg:w-[80%] sm:w-[50%]  gap-4 flex flex-col items-center '>
              ...
              <div className='flex flex-col pl-2 w-full'>
                ...
                <input className='w-[90%] sm:w-[80%] rounded-sm text-white ' type="file" name="file" id="file" onChange={handleSelect} />
              </div>

              <div className='w-full px-2'>{
                image && (<>
                  <img src={preview} width='100px' alt="" />
                  <button className='underline text-purple-800' onClick={handleRemove}>remove image</button>
                </>
              ...
              <div className='flex flex-col pl-2 w-full'>
                ...
                <input onChange={handleSelect2} className='w-[90%] sm:w-[80%] rounded-sm    text-white' type="file" name="file" id="file" />
              </div>

              <div className='w-full px-2'>{
                resume && (
                  <>
                    <img src={previewResume} width={'100px'} alt="" />
                    <button className='underline text-purple-800' onClick={() => { setResume(null), setPreviewResume(null) }}>remove resume</button>
                  </>
              ...
              <div className='flex flex-col pl-2 w-full'>
                ...
                <textarea className='w-[90%] sm:w-[80%] rounded-sm md:border  md:border-black' rows='4' type="text" name="skills" id="text"  value={data.skills} onChange={handleChange}/>
              </div>
              <div className='w-full px-2'>
                <button type='submit' className='w-[140px]  hover:bg-[#E45826] transition-all duration-300 hover:text-white p-3 text-xl font-semibold text-white md:text-[#0b0c1f] rounded-sm border-[#E45826] border my-4'> Build Profile</button>
              </div>
            </div>
      ...
      {
        list.map((el,id)=>{
          return <img key={id} src={el.pic} alt="" />
        })
      }
