...
function Loop() {
    ...
    <div className='rounded-[5px] w-[98%] md:w-[97%] h-min md:mt-10  overflow-hidden   text-[#07081c] '>
        <div className="content flex w-full transition-all duration-1000 ease-in-out h-full bg-white   shadow-lg shadow-[#65646411]   " style={{transform: `translateX(-${slide * 100}%)`}}>
            {
                arr.map((el,index)=>{
                    return <div key={index} className='w-full shrink-0 md:flex md:justify-center  md:pt-3 shadow-lg  shadow-[#65646411]'>
                        <figure className=' w-full flex flex-col items-center md:flex-row md:w-[98%]  border border-[#ffffff3a] lg:justify-around rounded-[5px]    shadow-[#65646411] bg-[white]   '>
