...
function QuestionsComponent() {
  return (
    ...
    <div className='w-full md:w-1/2 p-2 flex flex-col gap-5  '>
        <p className='text-[white] font-bold  text-2xl lg:text-3xl'>Interview Prep</p>
        <h1 className='text-3xl lg:text-4xl font-bold text-[#E45826] uppercase'> Preparing for Success: Strategies for Nailing Your Interview </h1>
        ...
        <Link to='/profile'>
        <button className='w-[190px] hover:bg-[#E45826] transition-all duration-300 hover:text-black p-3 text-xl font-semibold text-white rounded-sm border-[#E45826] border'> Start preparation</button>
        </Link>
    </div>
